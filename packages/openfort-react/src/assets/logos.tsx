...
const MetaMask = ({ background = false, ...props }) => (
  ...
  >
    <path
      ...
      fill="var(--ck-brand-metamask-01, #FF5C16)"
    />
    <path
    ...
    <path
      ...
      fill="var(--ck-brand-metamask-02, #E34807)"
    />
    <path
      ...
      fill="var(--ck-brand-metamask-03, #FF8D5D)"
    />
    <path
      ...
      fill="var(--ck-brand-metamask-04, #661800)"
    />
    <path d="M47.958 69.8843V76.0005H40.0292V69.8843H47.958Z" fill="var(--ck-brand-metamask-05, #C0C4CD)" />
    <path
      ...
      fill="var(--ck-brand-metamask-06, #E7EBF6)"
    />
  </svg>
)
...
const CoinbasePay = ({ ...props }) => (
  <svg
    ...
    style={{ enableBackground: 'new 0 0 1101.64 196.79' } as React.CSSProperties}
    xmlSpace="preserve"
  >
    <path
      fill="currentColor"
      d="M222.34,54.94c-40.02,0-71.29,30.38-71.29,71.05s30.48,70.79,71.29,70.79c40.81,0,71.82-30.64,71.82-71.05
...
const Binance = ({ ...props }) => (
  <svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
