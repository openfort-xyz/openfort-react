 ...
 * needs (email + US phone), reusing Openfort's OWN phone OTP. Reached from the
 * amount step (which already stamped the Guest-Checkout agreement) only when the
 * user's existing identity is incomplete. On success it stamps
 * phoneNumberVerifiedAt and hands off to the commit screen.
 */
const WalletPayContact: React.FC = () => {
  ...
  return (
    <PageContent onBack={handleBack}>
      ...
      {step === 'email' && (
        <>
          <ModalBody>Apple Pay and Google Pay need a verified email and phone. Enter your email to continue.</ModalBody>
          <Input
            value={email}
          ...
          <ContinueButtonWrapper>
            <Button variant="primary" onClick={handleEmailNext} disabled={!emailValid}>
              Continue
            </Button>
          </ContinueButtonWrapper>
        </>
