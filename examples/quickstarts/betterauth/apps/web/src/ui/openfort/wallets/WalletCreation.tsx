import { FingerPrintIcon, KeyIcon, LockClosedIcon, WalletIcon } from '@heroicons/react/24/outline'
    ...
    <>
            ...
            >
              ...
              <div className="flex flex-col text-start">
                ...
                <p className="text-sm hover-description">
                  ...
                  {type === AccountTypeEnum.SMART_ACCOUNT && 'A smart contract wallet (also creates an EOA owner).'}
      ...
      {step === 'choose-recovery-method' && (
        <>
          ...
          >
            ← Back · <span className="text-zinc-300">{accountType}</span>
          </button>
          <div className="flex flex-col gap-4 wallet-option-group mb-4">
